...
| Icon color override | Shared icon components keep a fixed base color; Menu Item explicitly overrides icons by Tone: Default → `fg/primary`, Danger → `fg/danger`, Disabled → `fg/disabled`; re-check after icon swap |
