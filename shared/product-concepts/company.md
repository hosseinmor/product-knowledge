...
title: سازمان
summary: مفهوم shared سازمان استخدام‌کننده را تعریف می‌کند که با label «سازمان» در Employer و «شرکت» در Candidate نمایش داده می‌شود.
status: draft
...
این concept نمایش shared یک سازمان استخدام‌کننده در Jobvision است. کاربران سمت Employer اطلاعات سازمان و فعالیت‌های استخدامی را مدیریت می‌کنند، در حالی که Candidate از طریق Job Postها، اطلاعات شرکت، دنبال‌کردن، امتیازدهی و نظرها با آن مواجه می‌شود.

نام مرجع concept در دانش محصول و تجربهٔ Employer «سازمان» است. در تجربهٔ
Candidate، وقتی دربارهٔ محل کار یا کارفرما به زبان روزمره صحبت می‌کنیم، label
«شرکت» ترجیح دارد. «کارفرما» نام actor یا نقش انسانی است و نباید به‌عنوان نام
این entity استفاده شود.
